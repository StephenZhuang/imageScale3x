...
ScalePic () {
    ...
    fileName3x=$1
    imageFile=${fileName3x/@3x\.png/\.png}
...
#    cp $imageFile $fileName3x
    ...
    sips -z $height1x $width1x $1 --out $imageFile
}

Contents () {
    renameFile3x=$1
    imageFile=${renameFile3x/@3x\.png/\.png}
...
do
    ...
    imageFile1x=${imageFile/@3x\.png/\.png}
    imageDir=${imageFile1x/\.png/\.imageset}
    mkdir $imageDir
